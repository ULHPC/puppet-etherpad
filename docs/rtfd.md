...
By default, the [puppet-etherpad](https://github.com/ULHPC/puppet-etherpad) repository is bound to the [ulhpc-puppet-etherpad](http://ulhpc-puppet-etherpad.rtfd.org) project on Read the Docs (to avoid confusion with other etherpad projects). 
