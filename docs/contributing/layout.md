...
│   ├── ...             # Implementation of the other etherpad::* classes / definitions
...
├── pkg/                # Hold build packages to be published on the [Puppet forge](https://forge.puppetlabs.com/ULHPC/etherpad)
